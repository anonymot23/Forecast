...
class AirDataPreProcessorXgboost(AirDataPreProcessor):
    ...
    def save_air(self, data: pd.DataFrame) -> None:
        ...
        """
        filename_air_save = filename_air_processed_xgboost()
...
def filename_air_processed_xgboost(suff: str = "") -> str:
    ...
    """
    return f"AirPassengersProcessedXgboost_{suff}.csv"
    
if __name__ == "__main__":
    # Test functions
    shift = 1
    lag = 12
    air_preprocessor = AirDataPreProcessorXgboost(shift, lag)
