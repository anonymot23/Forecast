...
class AirNhits(object):
    ...
    def __init__(self, input_chunk_len, fcst_horizon,
        ...
        self.model = NHiTSModel(input_chunk_length = self.input_chunk_len,
...
if __name__ == "__main__":
    ...
    ## import libraries
    from pre_process_data_nhits import AirDataPreProcessorNhits, split_air_data_darts
    ...
    input_chunk_len = 64
    fcst_horizon = 24
    modelNhits = AirNhits(input_chunk_len, fcst_horizon)
