...
from generate_fcst_xgboost import AirForecastGeneratorXgboost
...
def main_air_xgboost(params: dict = {}) -> None:
    ...
    # generate forecast
    air_fcst_generator = AirForecastGeneratorXgboost(train=True)
