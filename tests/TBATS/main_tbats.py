...
from generate_fcst_tbats import AirForecastGeneratorTbats
...
def main_air_tbats(params: dict = {}) -> None:
    ...
    air_fcst_generator = AirForecastGeneratorTbats(train=True)
